...
/**
 * Authenticates internal plane-to-plane endpoints via a shared secret.
 *
 * Callers (control-plane, other internal services) must attach the secret in
 * the `X-Internal-Secret` header. Comparison is constant-time to avoid timing

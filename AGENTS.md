...
Key vars: `DATABASE_URL`, `REDIS_URL`, `AUTH_JWT_SECRET`, `JWT_REFRESH_SECRET`, `COLLAB_JWT_SECRET`, `S3_ENDPOINT`, `S3_ACCESS_KEY`, `S3_SECRET_KEY`, `S3_BUCKET`, `LIVEKIT_API_KEY`, `LIVEKIT_API_SECRET`, `LIVEKIT_URL`, `COLLAB_PLANE_URL`, `E2B_API_KEY`, `OTEL_EXPORTER_OTLP_ENDPOINT`
